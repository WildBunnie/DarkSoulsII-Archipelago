...
item_list: list[ItemData] = [
    ...
    ItemData(1140000, "Blue Dagger", ItemCategory.WEAPON),
    ItemData(1150000, "Umbral Dagger", ItemCategory.WEAPON),
    ItemData(1160000, "Retainer's Short Sword", ItemCategory.WEAPON),
    ...
    ItemData(1250000, "Puzzling Stone Sword", ItemCategory.WEAPON),
    ItemData(1260000, "Possessed Armor Sword", ItemCategory.WEAPON),
    ItemData(1270000, "Varangian Sword", ItemCategory.WEAPON),
    ItemData(1280000, "Blue Flame", ItemCategory.WEAPON),
    ItemData(1290000, "Fume Sword", ItemCategory.WEAPON),
    ...
    ItemData(1380000, "Ashen Warrior Sword", ItemCategory.WEAPON),
    ItemData(1390000, "Ivory Straight Sword", ItemCategory.WEAPON),
    ...
    ItemData(1580000, "Ice Rapier", ItemCategory.WEAPON),
    ...
    ItemData(1630000, "Eleum Loyce", ItemCategory.WEAPON),
    ...
    ItemData(1790000, "Bewitched Alonne Sword", ItemCategory.WEAPON),
    ...
    ItemData(1830000, "Majestic Greatsword", ItemCategory.WEAPON),
    ...
    ItemData(2760000, "Sanctum Mace", ItemCategory.WEAPON),
    ...
    ItemData(2855000, "Yorgh's Spear", ItemCategory.WEAPON),
    ...
    ItemData(2950000, "Rampart Golem Lance", ItemCategory.WEAPON),
    ItemData(2960000, "Smelter Hammer", ItemCategory.WEAPON),
    ...
    ItemData(3370000, "Wrathful Axe", ItemCategory.WEAPON),
    ...
    ItemData(3530000, "Bone Fist", ItemCategory.WEAPON),
    ...
    ItemData(3910000, "Pilgrim's Spontoon", ItemCategory.WEAPON),
    ItemData(3930000, "Azal's Staff", ItemCategory.STAFF_OR_CHIME),
    ItemData(3940000, "Retainer Staff", ItemCategory.STAFF_OR_CHIME),
    ...
    ItemData(4120000, "Chime of Screams", ItemCategory.STAFF_OR_CHIME),
    ...
    ItemData(4430000, "Possessed Armor Greatbow", ItemCategory.WEAPON),
    ItemData(4440000, "Twin-headed Greatbow", ItemCategory.WEAPON),
    ...
    ItemData(4670000, "Sanctum Crossbow", ItemCategory.WEAPON),
    ItemData(4680000, "Sanctum Repeating Crossbow", ItemCategory.WEAPON),
    ...
    ItemData(5050000, "Curved Nil Greatsword", ItemCategory.WEAPON),
    ...
    ItemData(5250000, "Fume Ultra Greatsword", ItemCategory.WEAPON),
    ItemData(5255000, "Ivory King Ultra Greatsword", ItemCategory.WEAPON),
    ...
    ItemData(5370000, "Sorcerer's Twinblade", ItemCategory.WEAPON),
    ...
    ItemData(5600000, "Longsword (reskin)", ItemCategory.WEAPON),
    ItemData(5610000, "Murakumo (reskin)", ItemCategory.WEAPON),
    ItemData(5620000, "Blacksteel Katana (reskin)", ItemCategory.WEAPON),
    ItemData(5630000, "Rapier (reskin)", ItemCategory.WEAPON),
    ItemData(5640000, "Greataxe (reskin)", ItemCategory.WEAPON),
    ItemData(5650000, "Great Club (reskin)", ItemCategory.WEAPON),
    ItemData(5660000, "Caestus (reskin)", ItemCategory.WEAPON),
    ...
    ItemData(11150000, "Sanctum Shield", ItemCategory.WEAPON),
    ...
    ItemData(11290000, "Loyce Shield", ItemCategory.WEAPON),
    ItemData(11295000, "Charred Loyce Shield", ItemCategory.WEAPON),
    ItemData(11300000, "Spirit Tree Shield", ItemCategory.WEAPON),
    ItemData(11310000, "Golden Wing Shield", ItemCategory.WEAPON),
    ItemData(11320000, "Vessel Shield", ItemCategory.WEAPON),
    ...
    ItemData(11455000, "Rampart Golem Shield", ItemCategory.WEAPON),
    ...
    ItemData(21430100, "Durgo's Hat", ItemCategory.ARMOR),
    ...
    ItemData(21600100, "Drakeblood Helm", ItemCategory.ARMOR),
    ItemData(21600101, "Drakeblood Armor", ItemCategory.ARMOR),
    ItemData(21600102, "Drakeblood Gauntlets", ItemCategory.ARMOR),
    ItemData(21600103, "Drakeblood Leggings", ItemCategory.ARMOR),
    ItemData(21610100, "Northwarder Hood", ItemCategory.ARMOR),
    ItemData(21610101, "Northwarder Robe", ItemCategory.ARMOR),
    ItemData(21610102, "Northwarder Manchettes", ItemCategory.ARMOR),
    ItemData(21610103, "Northwarder Trousers", ItemCategory.ARMOR),
    ItemData(21630100, "Crown of the Old Iron King", ItemCategory.ARMOR),
    ItemData(21640100, "Crown of the Ivory King", ItemCategory.ARMOR),
    ItemData(21650100, "Crown of the Sunken King", ItemCategory.ARMOR),
    ItemData(21660100, "Old Bell Helm", ItemCategory.ARMOR),
    ItemData(21670100, "Hollow Skin", ItemCategory.ARMOR),
    ItemData(21680100, "Pharros Mask", ItemCategory.ARMOR),
    ItemData(21690103, "Flower Skirt", ItemCategory.ARMOR),
    ItemData(21700100, "Minotaur Helm", ItemCategory.ARMOR),
    ItemData(21710100, "Symbol of Avarice", ItemCategory.ARMOR),
    ...
    # ItemData(26510000, ""),
    ItemData(26510100, "Fume Sorcerer Mask", ItemCategory.ARMOR),
    ItemData(26510101, "Fume Sorcerer Robes", ItemCategory.ARMOR),
    ItemData(26510102, "Fume Sorcerer Gloves", ItemCategory.ARMOR),
    ItemData(26510103, "Fume Sorcerer Boots", ItemCategory.ARMOR),
    ItemData(26590100, "Rampart Golem Helm", ItemCategory.ARMOR),
    ItemData(26590101, "Rampart Golem Armor", ItemCategory.ARMOR),
    ItemData(26590102, "Rampart Golem Gauntlets", ItemCategory.ARMOR),
    ItemData(26590103, "Rampart Golem Leggings", ItemCategory.ARMOR),
    ItemData(26650100, "Sanctum Knight Helm", ItemCategory.ARMOR),
    ItemData(26650101, "Sanctum Knight Armor", ItemCategory.ARMOR),
    ItemData(26650102, "Sanctum Knight Gauntlets", ItemCategory.ARMOR),
    ItemData(26650103, "Sanctum Knight Leggings", ItemCategory.ARMOR),
    ItemData(26660102, "Sanctum Soldier Gauntlet", ItemCategory.ARMOR),
    ItemData(26700100, "Sanctum Priestess Tiara", ItemCategory.ARMOR),
    ItemData(26750100, "Raime's Helm", ItemCategory.ARMOR),
    ItemData(26750101, "Raime's Armor", ItemCategory.ARMOR),
    ItemData(26750102, "Raime's Gauntlets", ItemCategory.ARMOR),
    ItemData(26750103, "Raime's Leggings", ItemCategory.ARMOR),
    ItemData(26770101, "Retainer Robe", ItemCategory.ARMOR),
    ItemData(26800100, "Alonne's Helm", ItemCategory.ARMOR),
    ItemData(26800101, "Alonne's Armor", ItemCategory.ARMOR),
    ItemData(26800102, "Alonne's Gauntlets", ItemCategory.ARMOR),
    ItemData(26800103, "Alonne's Leggings", ItemCategory.ARMOR),
    # ItemData(26880000, ""),
    ItemData(26880100, "Loyce Helm", ItemCategory.ARMOR),
    ItemData(26880101, "Loyce Armor", ItemCategory.ARMOR),
    ItemData(26880102, "Loyce Gauntlets", ItemCategory.ARMOR),
    ItemData(26880103, "Loyce Leggings", ItemCategory.ARMOR),
    # ItemData(26890000, ""),
    ItemData(26890100, "Charred Loyce Helm", ItemCategory.ARMOR),
    ItemData(26890101, "Charred Loyce Armor", ItemCategory.ARMOR),
    ItemData(26890102, "Charred Loyce Gauntlets", ItemCategory.ARMOR),
    ItemData(26890103, "Charred Loyce Leggings", ItemCategory.ARMOR),
    ItemData(26900100, "Ivory King Helm", ItemCategory.ARMOR),
    ...
    ItemData(27521100, "Mirrah Hat", ItemCategory.ARMOR),
    ...
    ItemData(52000000, "Dragon Talon", ItemCategory.KEY_ITEM),
    ItemData(52100000, "Heavy Iron Key", ItemCategory.KEY_ITEM),
    ItemData(52200000, "Frozen Flower", ItemCategory.KEY_ITEM),
    ItemData(52300000, "Eternal Sanctum Key", ItemCategory.KEY_ITEM),
    ItemData(52400000, "Tower Key", ItemCategory.KEY_ITEM),
    ItemData(52500000, "Garrison Ward Key", ItemCategory.KEY_ITEM),
    ItemData(52650000, "Dragon Stone", ItemCategory.KEY_ITEM),
    ItemData(53100000, "Scorching Iron Scepter", ItemCategory.KEY_ITEM),
    ItemData(53200000, "Smelter Wedge", ItemCategory.CONSUMABLE),
    ItemData(53300000, "Soul of Nadalia, Bride of Ash", ItemCategory.CONSUMABLE),
    ItemData(53600000, "Eye of the Priestess", ItemCategory.KEY_ITEM),
    ...
    ItemData(60036000, "Dried Root", ItemCategory.CONSUMABLE),
    ...
    ItemData(60235000, "Old Growth Balm", ItemCategory.CONSUMABLE),
    ItemData(60236000, "Vine Balm", ItemCategory.CONSUMABLE),
    ItemData(60237000, "Blackweed Balm", ItemCategory.CONSUMABLE),
    ItemData(60238000, "Goldenfruit Balm", ItemCategory.CONSUMABLE),
    ...
    ItemData(64500000, "Soul of Sinh, the Slumbering Dragon", ItemCategory.CONSUMABLE),
    ItemData(64510000, "Soul of the Fume Knight", ItemCategory.CONSUMABLE),
    ItemData(64520000, "Soul of Aava, the King's Pet", ItemCategory.CONSUMABLE),
    ItemData(64530000, "Soul of Elana, Squalid Queen", ItemCategory.CONSUMABLE),
    ItemData(64540000, "Soul of Nadalia, Bride of Ash", ItemCategory.CONSUMABLE),
    ItemData(64550000, "Soul of Alsanna, Silent Oracle", ItemCategory.CONSUMABLE),
    ItemData(64560000, "Soul of Sir Alonne", ItemCategory.CONSUMABLE),
    ItemData(64580000, "Soul of the Ivory King", ItemCategory.CONSUMABLE),
    ItemData(64590000, "Soul of Zallen, the King's Pet", ItemCategory.CONSUMABLE),
