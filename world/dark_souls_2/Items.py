...
item_list: list[ItemData] = [
    ...
    ItemData(50880002, "Smooth & Silky Stone x2", ItemCategory.CONSUMABLE),
    ItemData(50880003, "Smooth & Silky Stone x3", ItemCategory.CONSUMABLE),
    ItemData(50880005, "Smooth & Silky Stone x5", ItemCategory.CONSUMABLE),
    ItemData(50880010, "Smooth & Silky Stone x10", ItemCategory.CONSUMABLE),
    ItemData(50885000, "Small Smooth & Silky Stone", ItemCategory.CONSUMABLE),
    ItemData(50885003, "Small Smooth & Silky Stone x3", ItemCategory.CONSUMABLE),
    ItemData(50885005, "Small Smooth & Silky Stone x5", ItemCategory.CONSUMABLE),
    ItemData(50885010, "Small Smooth & Silky Stone x10", ItemCategory.CONSUMABLE),
    ...
    ItemData(50960002, "Soul Vessel x2", ItemCategory.CONSUMABLE),
    ...
    ItemData(60010002, "Lifegem x2", ItemCategory.CONSUMABLE),
    ItemData(60010003, "Lifegem x3", ItemCategory.CONSUMABLE),
    ItemData(60010005, "Lifegem x5", ItemCategory.CONSUMABLE),
    ItemData(60010008, "Lifegem x8", ItemCategory.CONSUMABLE),
    ItemData(60010010, "Lifegem x10", ItemCategory.CONSUMABLE),
    ItemData(60010020, "Lifegem x20", ItemCategory.CONSUMABLE),
    ItemData(60020000, "Radiant Lifegem", ItemCategory.CONSUMABLE),
    ItemData(60020002, "Radiant Lifegem x2", ItemCategory.CONSUMABLE),
    ItemData(60020003, "Radiant Lifegem x3", ItemCategory.CONSUMABLE),
    ItemData(60020004, "Radiant Lifegem x4", ItemCategory.CONSUMABLE),
    ItemData(60020005, "Radiant Lifegem x5", ItemCategory.CONSUMABLE),
    ItemData(60020008, "Radiant Lifegem x8", ItemCategory.CONSUMABLE),
    ItemData(60020010, "Radiant Lifegem x10", ItemCategory.CONSUMABLE),
    ItemData(60030000, "Old Radiant Lifegem", ItemCategory.CONSUMABLE),
    ItemData(60030003, "Old Radiant Lifegem x3", ItemCategory.CONSUMABLE),
    ItemData(60030004, "Old Radiant Lifegem x4", ItemCategory.CONSUMABLE),
    ItemData(60030005, "Old Radiant Lifegem x5", ItemCategory.CONSUMABLE),
    ItemData(60030007, "Old Radiant Lifegem x7", ItemCategory.CONSUMABLE),
    ItemData(60030010, "Old Radiant Lifegem x10", ItemCategory.CONSUMABLE),
    ItemData(60035000, "Elizabeth Mushroom", ItemCategory.CONSUMABLE),
    ItemData(60035002, "Elizabeth Mushroom x2", ItemCategory.CONSUMABLE),
    ItemData(60035003, "Elizabeth Mushroom x3", ItemCategory.CONSUMABLE),
    ItemData(60035013, "Elizabeth Mushroom x13", ItemCategory.CONSUMABLE),
    ItemData(60036000, "Dried Root", ItemCategory.CONSUMABLE, dlc=DLC.ALL),
    ItemData(60036002, "Dried Root x2", ItemCategory.CONSUMABLE, dlc=DLC.ALL),
    ItemData(60036003, "Dried Root x3", ItemCategory.CONSUMABLE, dlc=DLC.ALL),
    ItemData(60036004, "Dried Root x4", ItemCategory.CONSUMABLE, dlc=DLC.ALL),
    ItemData(60036005, "Dried Root x5", ItemCategory.CONSUMABLE, dlc=DLC.ALL),
    ItemData(60040000, "Amber Herb", ItemCategory.CONSUMABLE),
    ItemData(60040002, "Amber Herb x2", ItemCategory.CONSUMABLE),
    ItemData(60040003, "Amber Herb x3", ItemCategory.CONSUMABLE),
    ItemData(60040005, "Amber Herb x5", ItemCategory.CONSUMABLE),
    ItemData(60040010, "Amber Herb x10", ItemCategory.CONSUMABLE),
    ItemData(60050000, "Twilight Herb", ItemCategory.CONSUMABLE),
    ItemData(60050002, "Twilight Herb x2", ItemCategory.CONSUMABLE),
    ItemData(60050005, "Twilight Herb x5", ItemCategory.CONSUMABLE),
    ItemData(60050010, "Twilight Herb x10", ItemCategory.CONSUMABLE),
    ItemData(60060000, "Wilted Dusk Herb", ItemCategory.CONSUMABLE),
    ItemData(60060002, "Wilted Dusk Herb x2", ItemCategory.CONSUMABLE),
    ItemData(60060003, "Wilted Dusk Herb x3", ItemCategory.CONSUMABLE),
    ItemData(60060004, "Wilted Dusk Herb x4", ItemCategory.CONSUMABLE),
    ItemData(60060010, "Wilted Dusk Herb x10", ItemCategory.CONSUMABLE),
    ItemData(60070000, "Poison Moss", ItemCategory.CONSUMABLE),
    ItemData(60070002, "Poison Moss x2", ItemCategory.CONSUMABLE),
    ItemData(60070003, "Poison Moss x3", ItemCategory.CONSUMABLE),
    ItemData(60070020, "Poison Moss x20", ItemCategory.CONSUMABLE),
    ItemData(60090000, "Monastery Charm", ItemCategory.CONSUMABLE),
    ItemData(60090002, "Monastery Charm x2", ItemCategory.CONSUMABLE),
    ItemData(60090003, "Monastery Charm x3", ItemCategory.CONSUMABLE),
    ItemData(60100000, "Dragon Charm", ItemCategory.CONSUMABLE),
    ItemData(60100003, "Dragon Charm x3", ItemCategory.CONSUMABLE),
    ItemData(60100005, "Dragon Charm x5", ItemCategory.CONSUMABLE),
    ItemData(60105000, "Divine Blessing", ItemCategory.CONSUMABLE),
    ItemData(60105002, "Divine Blessing x2", ItemCategory.CONSUMABLE),
    ItemData(60105003, "Divine Blessing x3", ItemCategory.CONSUMABLE),
    ItemData(60110000, "Rouge Water", ItemCategory.CONSUMABLE),
    ItemData(60110002, "Rouge Water x2", ItemCategory.CONSUMABLE),
    ItemData(60110003, "Rouge Water x3", ItemCategory.CONSUMABLE),
    ItemData(60120000, "Crimson Water", ItemCategory.CONSUMABLE),
    ItemData(60120002, "Crimson Water x2", ItemCategory.CONSUMABLE),
    ItemData(60120003, "Crimson Water x3", ItemCategory.CONSUMABLE),
    ItemData(60120005, "Crimson Water x5", ItemCategory.CONSUMABLE),
    ItemData(60151000, "Human Effigy", ItemCategory.CONSUMABLE),
    ItemData(60151002, "Human Effigy x2", ItemCategory.CONSUMABLE),
    ItemData(60151003, "Human Effigy x3", ItemCategory.CONSUMABLE),
    ItemData(60151004, "Human Effigy x4", ItemCategory.CONSUMABLE),
    ItemData(60151005, "Human Effigy x5", ItemCategory.CONSUMABLE),
    ItemData(60151006, "Human Effigy x6", ItemCategory.CONSUMABLE),
    ItemData(60151013, "Human Effigy x13", ItemCategory.CONSUMABLE),
    ...
    ItemData(60235002, "Old Growth Balm x2", ItemCategory.CONSUMABLE, dlc=DLC.ALL),
    ItemData(60235003, "Old Growth Balm x3", ItemCategory.CONSUMABLE, dlc=DLC.ALL),
    ItemData(60235005, "Old Growth Balm x5", ItemCategory.CONSUMABLE, dlc=DLC.ALL),
    ItemData(60236000, "Vine Balm", ItemCategory.CONSUMABLE, dlc=DLC.ALL),
    ItemData(60236002, "Vine Balm x2", ItemCategory.CONSUMABLE, dlc=DLC.ALL),
    ItemData(60236003, "Vine Balm x3", ItemCategory.CONSUMABLE, dlc=DLC.ALL),
    ItemData(60237000, "Blackweed Balm", ItemCategory.CONSUMABLE, dlc=DLC.ALL),
    ItemData(60237002, "Blackweed Balm x2", ItemCategory.CONSUMABLE, dlc=DLC.ALL),
    ItemData(60237003, "Blackweed Balm x3", ItemCategory.CONSUMABLE, dlc=DLC.ALL),
    ItemData(60238000, "Goldenfruit Balm", ItemCategory.CONSUMABLE, dlc=DLC.ALL),
    ItemData(60238002, "Goldenfruit Balm x2", ItemCategory.CONSUMABLE, dlc=DLC.ALL),
    ItemData(60238003, "Goldenfruit Balm x3", ItemCategory.CONSUMABLE, dlc=DLC.ALL),
    ItemData(60239000, "Brightbug", ItemCategory.CONSUMABLE),
    ItemData(60239002, "Brightbug x2", ItemCategory.CONSUMABLE),
    ItemData(60239003, "Brightbug x3", ItemCategory.CONSUMABLE),
    ItemData(60240000, "Aromatic Ooze", ItemCategory.CONSUMABLE),
    ItemData(60240003, "Aromatic Ooze x3", ItemCategory.CONSUMABLE),
    ItemData(60250000, "Gold Pine Resin", ItemCategory.CONSUMABLE),
    ItemData(60250004, "Gold Pine Resin x4", ItemCategory.CONSUMABLE),
    ItemData(60250006, "Gold Pine Resin x6", ItemCategory.CONSUMABLE),
    ItemData(60260000, "Charcoal Pine Resin", ItemCategory.CONSUMABLE),
    ItemData(60260003, "Charcoal Pine Resin x3", ItemCategory.CONSUMABLE),
    ItemData(60260005, "Charcoal Pine Resin x5", ItemCategory.CONSUMABLE),
    ItemData(60270000, "Dark Pine Resin", ItemCategory.CONSUMABLE),
    ItemData(60270003, "Dark Pine Resin x3", ItemCategory.CONSUMABLE),
    ItemData(60280000, "Rotten Pine Resin", ItemCategory.CONSUMABLE),
    ItemData(60280003, "Rotten Pine Resin x3", ItemCategory.CONSUMABLE),
    ItemData(60280020, "Rotten Pine Resin x20", ItemCategory.CONSUMABLE),
    ItemData(60290000, "Bleeding Serum", ItemCategory.CONSUMABLE),
    ItemData(60290003, "Bleeding Serum x3", ItemCategory.CONSUMABLE),
    ItemData(60290005, "Bleeding Serum x5", ItemCategory.CONSUMABLE),
    ItemData(60310000, "Green Blossom", ItemCategory.CONSUMABLE),
    ItemData(60310002, "Green Blossom x2", ItemCategory.CONSUMABLE),
    ItemData(60310003, "Green Blossom x3", ItemCategory.CONSUMABLE),
    ItemData(60310005, "Green Blossom x5", ItemCategory.CONSUMABLE),
    ItemData(60310008, "Green Blossom x8", ItemCategory.CONSUMABLE),
    ItemData(60310010, "Green Blossom x10", ItemCategory.CONSUMABLE),
    ItemData(60320000, "Rusted Coin", ItemCategory.CONSUMABLE),
    ItemData(60320003, "Rusted Coin x3", ItemCategory.CONSUMABLE),
    ItemData(60320005, "Rusted Coin x5", ItemCategory.CONSUMABLE),
    ItemData(60320008, "Rusted Coin x8", ItemCategory.CONSUMABLE),
    ItemData(60320010, "Rusted Coin x10", ItemCategory.CONSUMABLE),
    ItemData(60350000, "Homeward Bone", ItemCategory.CONSUMABLE),
    ItemData(60350003, "Homeward Bone x3", ItemCategory.CONSUMABLE),
    ItemData(60350005, "Homeward Bone x5", ItemCategory.CONSUMABLE),
    ItemData(60350010, "Homeward Bone x10", ItemCategory.CONSUMABLE),
    ...
    ItemData(60370002, "Silver Talisman x2", ItemCategory.CONSUMABLE),
    ItemData(60370004, "Silver Talisman x4", ItemCategory.CONSUMABLE),
    ItemData(60370005, "Silver Talisman x5", ItemCategory.CONSUMABLE),
    ItemData(60370010, "Silver Talisman x10", ItemCategory.CONSUMABLE),
    ...
    ItemData(60410002, "Repair Powder x2", ItemCategory.CONSUMABLE),
    ItemData(60410003, "Repair Powder x3", ItemCategory.CONSUMABLE),
    ItemData(60410005, "Repair Powder x5", ItemCategory.CONSUMABLE),
    ItemData(60420000, "Torch", ItemCategory.USABLE_ITEM),
    ItemData(60420002, "Torch x2", ItemCategory.USABLE_ITEM),
    ItemData(60420003, "Torch x3", ItemCategory.USABLE_ITEM),
    ItemData(60420004, "Torch x4", ItemCategory.USABLE_ITEM),
    ItemData(60420005, "Torch x5", ItemCategory.USABLE_ITEM),
    ItemData(60430000, "Flame Butterfly", ItemCategory.CONSUMABLE),
    ItemData(60430002, "Flame Butterfly x2", ItemCategory.CONSUMABLE),
    ItemData(60430003, "Flame Butterfly x3", ItemCategory.CONSUMABLE),
    ItemData(60430005, "Flame Butterfly x5", ItemCategory.CONSUMABLE),
    ItemData(60430010, "Flame Butterfly x10", ItemCategory.CONSUMABLE),
    ItemData(60450000, "Prism Stone", ItemCategory.CONSUMABLE),
    ItemData(60450004, "Prism Stone x4", ItemCategory.CONSUMABLE),
    ItemData(60450010, "Prism Stone x10", ItemCategory.CONSUMABLE),
    ItemData(60450015, "Prism Stone x15", ItemCategory.CONSUMABLE),
    ...
    ItemData(60511003, "Petrified Something x3", ItemCategory.CONSUMABLE),
    ...
    ItemData(60527002, "Bonfire Ascetic x2", ItemCategory.CONSUMABLE),
    ItemData(60527003, "Bonfire Ascetic x3", ItemCategory.CONSUMABLE),
    ItemData(60527010, "Bonfire Ascetic x10", ItemCategory.CONSUMABLE),
    ItemData(60530000, "Alluring Skull", ItemCategory.CONSUMABLE),
    ItemData(60530003, "Alluring Skull x3", ItemCategory.CONSUMABLE),
    ItemData(60530005, "Alluring Skull x5", ItemCategory.CONSUMABLE),
    ItemData(60530010, "Alluring Skull x10", ItemCategory.CONSUMABLE),
    ItemData(60531000, "Lloyd's Talisman", ItemCategory.CONSUMABLE),
    ItemData(60531002, "Lloyd's Talisman x2", ItemCategory.CONSUMABLE),
    ItemData(60531003, "Lloyd's Talisman x3", ItemCategory.CONSUMABLE),
    ItemData(60531005, "Lloyd's Talisman x5", ItemCategory.CONSUMABLE),
    ItemData(60531010, "Lloyd's Talisman x10", ItemCategory.CONSUMABLE),
    ...
    ItemData(60538003, "Fire Seed x3", ItemCategory.UPGRADE_MATERIAL),
    ItemData(60540000, "Throwing Knife", ItemCategory.CONSUMABLE),
    ItemData(60540007, "Throwing Knife x7", ItemCategory.CONSUMABLE),
    ItemData(60540010, "Throwing Knife x10", ItemCategory.CONSUMABLE),
    ItemData(60540020, "Throwing Knife x20", ItemCategory.CONSUMABLE),
    ItemData(60550000, "Witching Urn", ItemCategory.CONSUMABLE),
    ItemData(60550005, "Witching Urn x5", ItemCategory.CONSUMABLE),
    ItemData(60560000, "Lightning Urn", ItemCategory.CONSUMABLE),
    ItemData(60560004, "Lightning Urn x4", ItemCategory.CONSUMABLE),
    ItemData(60560005, "Lightning Urn x5", ItemCategory.CONSUMABLE),
    ItemData(60570000, "Firebomb", ItemCategory.CONSUMABLE),
    ItemData(60570003, "Firebomb x3", ItemCategory.CONSUMABLE),
    ItemData(60575000, "Black Firebomb", ItemCategory.CONSUMABLE),
    ItemData(60575002, "Black Firebomb x2", ItemCategory.CONSUMABLE),
    ItemData(60575003, "Black Firebomb x3", ItemCategory.CONSUMABLE),
    ItemData(60575005, "Black Firebomb x5", ItemCategory.CONSUMABLE),
    ItemData(60580000, "Hexing Urn", ItemCategory.CONSUMABLE),
    ItemData(60580003, "Hexing Urn x3", ItemCategory.CONSUMABLE),
    ItemData(60580010, "Hexing Urn x10", ItemCategory.CONSUMABLE),
    ItemData(60590000, "Poison Throwing Knife", ItemCategory.CONSUMABLE),
    ItemData(60590010, "Poison Throwing Knife x10", ItemCategory.CONSUMABLE),
    ItemData(60590015, "Poison Throwing Knife x15", ItemCategory.CONSUMABLE),
    ItemData(60590020, "Poison Throwing Knife x20", ItemCategory.CONSUMABLE),
    ItemData(60595000, "Dung Pie", ItemCategory.CONSUMABLE),
    ItemData(60595002, "Dung Pie x2", ItemCategory.CONSUMABLE),
    ItemData(60595003, "Dung Pie x3", ItemCategory.CONSUMABLE),
    ItemData(60595010, "Dung Pie x10", ItemCategory.CONSUMABLE),
    ItemData(60600000, "Lacerating Knife", ItemCategory.CONSUMABLE),
    ItemData(60600005, "Lacerating Knife x5", ItemCategory.CONSUMABLE),
    ItemData(60600015, "Lacerating Knife x15", ItemCategory.CONSUMABLE),
    ItemData(60600020, "Lacerating Knife x20", ItemCategory.CONSUMABLE),
    ItemData(60610000, "Corrosive Urn", ItemCategory.CONSUMABLE),
    ItemData(60610003, "Corrosive Urn x3", ItemCategory.CONSUMABLE),
    ItemData(60610004, "Corrosive Urn x4", ItemCategory.CONSUMABLE),
    ItemData(60610005, "Corrosive Urn x5", ItemCategory.CONSUMABLE),
    ItemData(60620000, "Holy Water Urn", ItemCategory.CONSUMABLE),
    ItemData(60620002, "Holy Water Urn x2", ItemCategory.CONSUMABLE),
    ItemData(60620003, "Holy Water Urn x3", ItemCategory.CONSUMABLE),
    ItemData(60620004, "Holy Water Urn x4", ItemCategory.CONSUMABLE),
    ItemData(60620005, "Holy Water Urn x5", ItemCategory.CONSUMABLE),
    ItemData(60625000, "Fading Soul", ItemCategory.CONSUMABLE),
    ItemData(60625020, "Fading Soul x20", ItemCategory.CONSUMABLE),
    ...
    ItemData(60710003, "Soul of a Hero x3", ItemCategory.CONSUMABLE),
    ...
    ItemData(60770010, "Iron Arrow x10", ItemCategory.AMMO),
    ItemData(60770020, "Iron Arrow x20", ItemCategory.AMMO),
    ItemData(60770030, "Iron Arrow x30", ItemCategory.AMMO),
    ItemData(60770050, "Iron Arrow x50", ItemCategory.AMMO),
    ItemData(60780000, "Magic Arrow", ItemCategory.AMMO),
    ItemData(60780015, "Magic Arrow x15", ItemCategory.AMMO),
    ItemData(60780020, "Magic Arrow x20", ItemCategory.AMMO),
    ItemData(60780030, "Magic Arrow x30", ItemCategory.AMMO),
    ItemData(60790000, "Lightning Arrow", ItemCategory.AMMO),
    ItemData(60800000, "Fire Arrow", ItemCategory.AMMO),
    ItemData(60800010, "Fire Arrow x10", ItemCategory.AMMO),
    ItemData(60800020, "Fire Arrow x20", ItemCategory.AMMO),
    ItemData(60800030, "Fire Arrow x30", ItemCategory.AMMO),
    ItemData(60810000, "Dark Arrow", ItemCategory.AMMO),
    ItemData(60810015, "Dark Arrow x15", ItemCategory.AMMO),
    ItemData(60810030, "Dark Arrow x30", ItemCategory.AMMO),
    ItemData(60820000, "Poison Arrow", ItemCategory.AMMO),
    ItemData(60820015, "Poison Arrow x15", ItemCategory.AMMO),
    ItemData(60820020, "Poison Arrow x20", ItemCategory.AMMO),
    ItemData(60830000, "Lacerating Arrow", ItemCategory.AMMO),
    ItemData(60830015, "Lacerating Arrow x15", ItemCategory.AMMO),
    ItemData(60850000, "Iron Greatarrow", ItemCategory.AMMO),
    ItemData(60850020, "Iron Greatarrow x20", ItemCategory.AMMO),
    ItemData(60870000, "Lightning Greatarrow", ItemCategory.AMMO),
    ItemData(60880000, "Fire Greatarrow", ItemCategory.AMMO),
    ItemData(60880010, "Fire Greatarrow x10", ItemCategory.AMMO),
    ItemData(60880020, "Fire Greatarrow x20", ItemCategory.AMMO),
    ItemData(60880030, "Fire Greatarrow x30", ItemCategory.AMMO),
    ItemData(60900000, "Destructive Greatarrow", ItemCategory.AMMO),
    ItemData(60900010, "Destructive Greatarrow x10", ItemCategory.AMMO),
    ItemData(60900015, "Destructive Greatarrow x15", ItemCategory.AMMO),
    ItemData(60900020, "Destructive Greatarrow x20", ItemCategory.AMMO),
    ItemData(60900030, "Destructive Greatarrow x30", ItemCategory.AMMO),
    ItemData(60900050, "Destructive Greatarrow x50", ItemCategory.AMMO),
    ItemData(60910000, "Wood Bolt", ItemCategory.AMMO),
    ItemData(60910020, "Wood Bolt x20", ItemCategory.AMMO),
    ItemData(60920000, "Heavy Bolt", ItemCategory.AMMO),
    ItemData(60920010, "Heavy Bolt x10", ItemCategory.AMMO),
    ItemData(60920015, "Heavy Bolt x15", ItemCategory.AMMO),
    ItemData(60920020, "Heavy Bolt x20", ItemCategory.AMMO),
    ItemData(60920050, "Heavy Bolt x50", ItemCategory.AMMO),
    ItemData(60930010, "Magic Bolt x10", ItemCategory.AMMO),
    ItemData(60930020, "Magic Bolt x20", ItemCategory.AMMO),
    ItemData(60930030, "Magic Bolt x30", ItemCategory.AMMO),
    ...
    ItemData(62050003, "Cracked Blue Eye Orb x3", ItemCategory.CONSUMABLE, skip=True),
    ItemData(62060000, "Cracked Red Eye Orb", ItemCategory.CONSUMABLE, skip=True),
    ItemData(62060002, "Cracked Red Eye Orb x2", ItemCategory.CONSUMABLE, skip=True),
    ItemData(62060003, "Cracked Red Eye Orb x3", ItemCategory.CONSUMABLE, skip=True),
    ItemData(62060005, "Cracked Red Eye Orb x5", ItemCategory.CONSUMABLE, skip=True),
