...
item_list: list[ItemData] = [
    ...
    ItemData(7, "Unpetrify Statue near Manscorpion Tark", ItemCategory.STATUE),
    ItemData(8, "Unpetrify Statue near Black Knight Halberd", ItemCategory.STATUE, sotfs=True),
