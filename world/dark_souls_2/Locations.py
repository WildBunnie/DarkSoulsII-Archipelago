...
location_table = {
    ...
    "Majula": [
        ...
        LocationData(76900310, "[Licia of Lindeldt - Shrine of Winter] Heal", ["Heal"], shop=True),
        LocationData(76900311, "[Licia of Lindeldt - Shrine of Winter] Med Heal", ["Med Heal"], shop=True),
        LocationData(76900312, "[Licia of Lindeldt - Shrine of Winter] Great Heal Excerpt", ["Great Heal Excerpt"], shop=True),
        LocationData(76900313, "[Licia of Lindeldt - Shrine of Winter] Replenishment", ["Replenishment"], shop=True),
        LocationData(76900314, "[Licia of Lindeldt - Shrine of Winter] Resplendent Life", ["Resplendent Life"], shop=True),
        LocationData(76900315, "[Licia of Lindeldt - Shrine of Winter] Caressing Prayer", ["Caressing Prayer"], shop=True),
        LocationData(76900316, "[Licia of Lindeldt - Shrine of Winter] Force", ["Force"], shop=True),
        LocationData(76900317, "[Licia of Lindeldt - Shrine of Winter] Lightning Spear", ["Lightning Spear"], shop=True),
        LocationData(76900318, "[Licia of Lindeldt - Shrine of Winter] Homeward", ["Homeward"], shop=True),
        LocationData(76900319, "[Licia of Lindeldt - Shrine of Winter] Guidance", ["Guidance"], shop=True),
    ],
    ...
    "Aldia's Keep": [
        ...
        LocationData(1157000, "[AldiasKeep] Petrified Undead Traveller just before Giant Basilisk", ['Bonfire Ascetic']),
        LocationData(1157100, "[AldiasKeep] Centre petrified Undead Traveller just before Giant Basilisk", ['Wilted Dusk Herb', 'Elizabeth Mushroom']),
        LocationData(1150000, "[AldiasKeep] Drop from Petrified Ogre blocking stairway near Bone Dragon", ['Dragon Acolyte Mask']),
    ...
    "Lost Bastille": [
        ...
        LocationData(76430007, "[Steady Hand McDuff - Dull Ember] Uchigatana", ["Uchigatana"], shop=True),
        LocationData(76430008, "[Steady Hand McDuff - Dull Ember] Bastard Sword", ["Bastard Sword"], shop=True),
        LocationData(76430009, "[Steady Hand McDuff - Dull Ember] Greataxe", ["Greataxe"], shop=True),
        LocationData(76430010, "[Steady Hand McDuff - Dull Ember] Winged Spear", ["Winged Spear"], shop=True),
        LocationData(76430011, "[Steady Hand McDuff - Dull Ember] Scythe", ["Scythe"], shop=True),
        LocationData(76430012, "[Steady Hand McDuff - Dull Ember] Long Bow", ["Long Bow"], shop=True),
        LocationData(76430013, "[Steady Hand McDuff - Dull Ember] Light Crossbow", ["Light Crossbow"], shop=True),
        LocationData(76430102, "[Steady Hand McDuff - Dull Ember] Royal Kite Shield", ["Royal Kite Shield"], shop=True),
    ...
    "Shaded Woods": [
        ...
        LocationData(1320100, "[ShadedWoods] Drop from Petrified Lion Warrior next to Golden Lion Warrior", ['Warlock Mask'], sotfs=True),
