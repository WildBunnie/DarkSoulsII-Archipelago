...
location_table: Dict[str, List[LocationData]] = {
    ...
    "Forest of Fallen Giants": [
        ...
        LocationData(10105070, "[FOFG] Metal chest in upper floor of cardinal tower", ["Estus Flask Shard", "Small White Sign Soapstone"]),
        ...
        LocationData(10106120, "[FOFG] In the small stone house near Soldier's Rest bonfire", ["Bastard Sword"]),
        ...
        LocationData(10106310, "[FOFG] In small tunnel guarded by turtle", ["Hollow Soldier Helm"]),
        ...
        LocationData(10106360, "[FOFG] Second corpse in the lower fire area", ["Rebel's Greatshield"]),
        ...
        LocationData(10106420, "[FOFG] On scaffolding near the Place Unbeknownst bonfire", ["Twinkling Titanite"]),
    ...
    "Brightstone Cove": [
        ...
        LocationData(10146040, "[Tseldora] Hanging from window behind illusory wall before congregation", ["Estus Flask Shard"]),
    ...
    "Aldia's Keep": [
        ...
        LocationData(10156100, "[AldiasKeep] In the acid pool (2)", ["Aldia Key"]),
    ...
    "Lost Bastille": [
        ...
        LocationData(10165140, "[Bastille] Metal chest where Pursuer attacks near the Tower Apart", ["Antiquated Key", "Covetous Silver Serpent Ring"]),
        ...
        LocationData(10166120, "[SinnersRise] Left side just after bottom of elevator", ["Sublime Bone Dust"]),
        ...
        LocationData(10166180, "[Bastille] On ledge behind boxes", ["Human Effigy"]),
        ...
        LocationData(10166250, "[BelfryLuna] At lower level in pit after Gargoyles", ["Bastille Key"]),
    ...
    "Earthen Peak": [
        ...
        LocationData(10176100, "[EarthernPeak] In a poison filled corridor in the lowest level", ["Estus Flask Shard"]),
        ...
        LocationData(10176390, "[HarvestValley] On a ledge after the tunnel leading away from the area with multiple sickle undeads", ["Fragrant Branch of Yore"]),
    ...
    "No-man's Wharf": [
        ...
        LocationData(10185110, "[Wharf] Metal chest in the poison jar room", ["Estus Flask Shard"]),
        ...
        LocationData(10186030, "[Wharf] Behind a shelf in alcove", ["Ring of Life Protection"]),
    ...
    "Iron Keep": [
        ...
        LocationData(10195150, "[IronKeep] Metal chest after Old Iron King", ["Sublime Bone Dust"]),
        ...
        LocationData(10196140, "[IronKeep] On lava on the right of bridge by first bonfire", ["Bonfire Ascetic"]),
        LocationData(10196150, "[IronKeep] Behind illusory wall next to ballista", ["Fire Arrow"]),
        LocationData(10196160, "[IronKeep] On broken stairs in the first big lava room", ["Dull Ember"]),
    ...
    "Huntman's Copse": [
        ...
        LocationData(10236140, "[Copse] Next to portcullis in the necromancer cave", ["Flame Butterfly"]),
        LocationData(10236150, "[Copse] On the pillar under the chariot bridge", ["Pharros' Lockstone", "Token of Fidelity"]),
        LocationData(10236160, "[Copse] Where Merciless Roenna invades", ["Poison Throwing Knife"]),
        LocationData(10236170, "[Copse] On a small ledge where you drop from the area where Merciless Roenna invades", ["Poison Moss"]),
        ...
        LocationData(10236230, "[Copse] Round hut on the way to Skeleton Lords", ["Undead Lockaway Key"]),
        LocationData(10236240, "[Copse] On the side ledge just before Executioner's Chariot boss", ["Sublime Bone Dust", "Fire Seed"]),
    ...
    "The Gutter": [
        ...
        LocationData(10255110, "[Gutter] Metal chest in the base of the tower where the zip-line starts", ["Ring of the Evil Eye"]),
        LocationData(10255120, "[Gulch] Metal chest after the Rotten", ["Sublime Bone Dust"]),
    ...
    "Dragon Aerie": [
        ...
        LocationData(10275050, "[DragonShrine] Metal chest on outer ledge next to the petrified egg", ["Crystal Magic Weapon"]),
        LocationData(10275060, "[DragonShrine] Metal chest behind the Pharros contraption under the staircase", ["Staff of Wisdom", "Mask of Judgment", "Robe of Judgment", "Manchettes of Judgment", "Tights of Judgment"]),
        LocationData(10275070, "[DragonShrine] Metal chest next to the petrified egg", ["Watchdragon Parma"]),
    ...
    "Heide's Tower of Flame": [
        ...
        LocationData(10315000, "[Heides] Metal chest before Dragonrider", ["Green Blossom"]),
        LocationData(10315001, "[Heides] Metal chest before Dragonrider in NG+", ["Human Effigy", "Green Blossom"], ngp=True),
        LocationData(10315010, "[Heides] Metal chest after Old Dragonslayer", ["Heide Knight Iron Mask", "Tower Shield"]),
        LocationData(10315020, "[Heides] Wooden chest after Old Dragonslayer", ["Cracked Blue Eye Orb"]),
        LocationData(10315030, "[Heides] Metal chest before Old Dragonslayer", ["Ring of Binding", "Human Effigy"]),
    ...
    "Shaded Woods": [
        ...
        LocationData(10325100, "[ShadedWoods] Metal chest blocked by petrified statue", ["Human Effigy", "Bleeding Serum"]),
        ...
        LocationData(10326020, "[ShadedWoods] On a ledge on left side of the path between Ruined Fork Road bonfire and Shrine of Winter", ["Ring of Life Protection", "Large Soul of a Proud Knight"]),
        ...
        LocationData(10326160, "[ShadedWoods] Room where Ornifex is locked", ["Estus Flask Shard"]),
        ...
        LocationData(10326220, "[ShadedWoods] Behind the ruined gate", ["Repair", "Large Soul of a Lost Undead"]),
    ...
    "Giant's Memory": [
        ...
        LocationData(20105010, "[MemoryVammar] Metal chest in the corner of the main battlefield area", ["Blossom Kite Shield"]),
        ...
        LocationData(20105060, "[MemoryOrro] Metal chest in the room where you need to drop the crane (2)", ["Grand Lance"]),
    ...
    "Drangleic Castle": [
        ...
        LocationData(20216040, "[Drangleic] In the room with cursed painting of Nashandra", ["Large Soul of a Brave Warrior", "Twinkling Titanite"]),
    ...
    "Shulva": [
        ...
        LocationData(50355010, "[DLC1] Trapped wooden chest close to the first rotating door", ["Bonfire Ascetic"]),
        ...
        LocationData(50355230, "[DLC1] Metal chest behind the door that is opened with eternal sanctum key (4)", ["Dried Root"]),
    ...
    #     LocationData(1502010, "[ShadedWoods] Gift from manscorpion Tark after defeating Freja", ["Second Dragon Ring"]),
    ...
    #     LocationData(1721000, "[Drangleic] Gift from Chancellor Wellager after defeating the Giant Lord", ["Royal Dirk", "Espada Ropera"]),
    ...
    #     LocationData(1760110, "[Amana] Gift from Milfanito near Rise of the Dead bonfire", ["Smooth & Silky Stone"]),
